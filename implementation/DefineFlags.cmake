...
ENDIF(UNIX)
#IF   (CYGWIN)
#  MESSAGE(SEND_ERROR "CYGWIN detected")
#ENDIF(CYGWIN)
...
# suppress rules to re-run cmake
# will break dependency checking nad possibly cmake integrity checks.
# Be warned!
...
IF (WIN32_STYLE_FLAGS)
  ...
  OPTION(NODEFAULTLIBS_OVERRIDE "use /NODEFAULTLIB:... settings to avoid clash between system libs?" ON)
  MARK_AS_ADVANCED(NODEFAULTLIBS_OVERRIDE)
...
IF (NOT  DEFINEFLAGS_HAS_RUN)
  ...
  IF (UNIX_STYLE_FLAGS)
    ...
    SET(CMAKE_CXX_FLAGS_DEBUG_OPENMP 
      "-g -Wall -pedantic -g3 -ggdb -gdwarf-2 -Wunused-variable -Wno-long-long -Wno-unknown-pragmas -Wno-system-headers -fopenmp -D _DEBUG"
      CACHE STRING "Debug builds CMAKE CXX flags " FORCE )
    SET(CMAKE_C_FLAGS_DEBUG_OPENMP "-g -Wall -pedantic -g3 -ggdb -gdwarf-2 -fopenmp -D _DEBUG"
      CACHE STRING "Flags used by the compiler during Debug builds." FORCE )
    ...
    SET(CMAKE_CXX_FLAGS_P4SSE "-O3 -march=pentium4 -msse -msse2 -mfpmath=sse -minline-all-stringops -Wall -pedantic -Wno-long-long " 
      CACHE STRING "Flags used by the compiler during P$SSE builds.")
    SET(CMAKE_C_FLAGS_P4SSE "-O3 -march=pentium4 -msse -msse2 -mfpmath=sse -minline-all-stringops -Wall -pedantic" 
    ...
    SET(CMAKE_CXX_FLAGS_P4SSEPROF "-O3 -march=pentium4 -msse -msse2 -mfpmath=sse -minline-all-stringops -g -pg -Wall -pedantic -Wno-long-long" 
      CACHE STRING "Flags used by the compiler during profiling builds.")
    SET(CMAKE_C_FLAGS_P4SSEPROF "-O3 -march=pentium4 -msse -msse2 -mfpmath=sse -minline-all-stringops -g -pg -Wall -pedantic" 
      CACHE STRING "Flags used by the compiler during profiling builds.")
    ...
    SET(CMAKE_CXX_FLAGS_P4SSEDEB "-O3 -march=pentium4 -msse -msse2 -mfpmath=sse -minline-all-stringops -g -Wall -pedantic -Wno-long-long " 
      CACHE STRING "Flags used by the compiler during P4SSEDEB builds.")
    SET(CMAKE_C_FLAGS_P4SSEDEB "-O3 -march=pentium4 -msse -msse2 -mfpmath=sse -minline-all-stringops -g -Wall -pedantic" 
      CACHE STRING "Flags used by the compiler during P4SSEDEB builds.")
    ...
    # Pentium-M
    SET(CMAKE_CXX_FLAGS_PM "-pipe -O3 -march=pentium4 -mmmx -msse -msse2 -mfpmath=sse,387 -maccumulate-outgoing-args -mno-align-stringops -fomit-frame-pointer -ffast-math -funroll-all-loops -fsched-spec-load -fprefetch-loop-arrays -ftracer --param max-gcse-passes=4 -Wall -pedantic -Wno-long-long"
      CACHE STRING "Flags used by the compiler during PM builds.")
    SET(CMAKE_C_FLAGS_PM "-pipe -O3 -march=pentium4 -mmmx -msse -msse2 -mfpmath=sse,387 -maccumulate-outgoing-args -mno-align-stringops -fomit-frame-pointer -ffast-math -funroll-all-loops -fsched-spec-load -fprefetch-loop-arrays -ftracer --param max-gcse-passes=4 -Wall -pedantic"
      CACHE STRING "Flags used by the compiler during PM builds." )
  ...
  IF (WIN32_STYLE_FLAGS)
    ...
    #
    IF(CMAKE_BUILD_TOOL MATCHES "(msdev|devenv|VCExpress|nmake)")
    ...
    ELSE (CMAKE_BUILD_TOOL MATCHES "(msdev|devenv|VCExpress|nmake)")
      # HACK
      MESSAGE("Your CMAKE_BUILD_TOOL=${CMAKE_BUILD_TOOL} is unsupported. Using default CMAKE_C_WARNING_LEVEL")
      SET(CMAKE_CXX_WARNING_LEVEL 4 
        CACHE STRING "compiler warning level for CPP" FORCE)

      SET(CMAKE_C_WARNING_LEVEL 3
        CACHE STRING "compiler warning level for C" FORCE)      
    ENDIF(CMAKE_BUILD_TOOL MATCHES "(msdev|devenv|VCExpress|nmake)")    
    ...
    IF(NODEFAULTLIBS_OVERRIDE)
      ...
      # handle system defaultlibs explicitly.
      # 
      ...
      # (3) Keep in mind that a single build tree may contain different buidl configurations
      #     e.g. with MSVS IDE.
      #
      # You should really know what you do if you change something here.
      # At least know the exact differences between:
      ...
      #
      # Jan Woetzel 08/2005 - 3/2007
      #

      #MESSAGE(STATUS "Initializing for (Debug/Release) multithreaded DLL defaultlibs ")

      # required for precompiled static xml2 usage bogo,jw
      # TODO
      STRING_APPEND( CMAKE_EXE_LINKER_FLAGS_DEBUG      "/NODEFAULTLIB:\"msvcrt.lib\"")
      STRING_APPEND( CMAKE_EXE_LINKER_FLAGS_RELEASE    "/NODEFAULTLIB:\"msvcrtd.lib\"")
      STRING_APPEND( CMAKE_SHARED_LINKER_FLAGS_DEBUG   "/NODEFAULTLIB:\"msvcrt.lib\"")
      STRING_APPEND( CMAKE_SHARED_LINKER_FLAGS_RELEASE "/NODEFAULTLIB:\"msvcrtd.lib\"")
      ...
      # Possibly needed for ExternLibs wxWidgets/Videosource - but not 100% sure.
      STRING_APPEND( CMAKE_EXE_LINKER_FLAGS_DEBUG      "/NODEFAULTLIB:\"libcmt.lib\"")
      STRING_APPEND( CMAKE_EXE_LINKER_FLAGS_RELEASE    "/NODEFAULTLIB:\"libcmtd.lib\"")
      STRING_APPEND( CMAKE_SHARED_LINKER_FLAGS_DEBUG   "/NODEFAULTLIB:\"libcmt.lib\"")
      STRING_APPEND( CMAKE_SHARED_LINKER_FLAGS_RELEASE "/NODEFAULTLIB:\"libcmtd.lib\"")
